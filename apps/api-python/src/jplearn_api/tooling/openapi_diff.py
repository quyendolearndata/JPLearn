...
REQUIRED_OPERATIONS = {
    ...
    ("/catalog", "get"),
    ("/catalog/search", "get"),
    ("/catalog/{id}/content", "get"),
    ("/staff/catalog", "post"),
    ("/staff/catalog/{id}/content", "get"),
    ("/staff/catalog/{id}/content", "put"),
    ("/staff/catalog/{id}/submit-qa", "post"),
    ("/staff/catalog/{id}/return-to-draft", "post"),
    ...
    ("/staff/series", "get"),
    ("/staff/series/{id}", "get"),
    ("/staff/series/{id}", "patch"),
    ("/staff/series/{id}/items", "put"),
    ("/staff/series/{id}/submit-qa", "post"),
    ("/staff/series/{id}/return-to-draft", "post"),
    ("/staff/series/{id}/publish", "post"),
    ("/staff/series/{id}/unpublish", "post"),
    ("/me/saved-scenes", "get"),
    ("/me/saved-scenes/{scene_id}", "put"),
    ("/me/saved-scenes/{scene_id}", "delete"),
    ("/me/collections", "post"),
    ("/me/collections", "get"),
    ("/me/collections/{collection_id}", "get"),
    ("/me/collections/{collection_id}", "patch"),
    ("/me/collections/{collection_id}/scenes", "put"),
    ("/me/collections/{collection_id}", "delete"),
    ("/catalog/{id}/reports", "post"),
    ("/me/content-reports", "get"),
    ("/me/content-reports/{id}", "get"),
    ("/staff/content-reports", "get"),
    ("/staff/content-reports/{id}", "get"),
    ("/staff/content-reports/{id}", "patch"),
    ("/playbacks", "post"),
    ("/playbacks/{id}", "get"),
    ("/playbacks/{id}/checkpoints/{seq}", "put"),
    ("/playbacks/{id}/end", "post"),
    ("/me/resume", "get"),
    ("/me/resume/{catalog_item_id}", "get"),
    ("/me/learning-preferences", "get"),
    ("/me/learning-preferences", "put"),
    ("/me/activity", "get"),
    ("/me/watch-history", "get"),
    ("/me/watch-history", "delete"),
    ("/me/history-deletions/{deletion_id}", "get"),
    ("/me/recommendations", "get"),
    ("/staff/catalog/{id}/transcript", "get"),
    ("/staff/catalog/{id}/transcript", "put"),
    ("/staff/catalog/{id}/transcript/submit-qa", "post"),
    ("/staff/catalog/{id}/transcript/approve", "post"),
    ("/staff/catalog/{id}/transcript/return-to-draft", "post"),
    ("/staff/catalog/{id}/language-analysis-jobs", "post"),
    ("/staff/language-analysis-jobs/{id}", "get"),
    ("/staff/ai-usage", "get"),
    ("/staff/ai-usage/summary", "get"),
    ("/staff/catalog/{id}/content-jobs", "post"),
    ("/staff/content-jobs/{id}", "get"),
    ("/staff/content-jobs/{id}/cancel", "post"),
    ("/staff/content-jobs/{id}/apply", "post"),
}
