...
import pytest
from test_playback_tracking import test_env
from jplearn_api.application.commands import StartPlaybackCommand, SendCheckpointCommand, EndPlaybackCommand
from jplearn_api.application.handlers.playback import handle_start_playback, handle_send_checkpoint, handle_end_playback
...
async def test_flag_off_and_fingerprint_and_terminal_immutability(test_env):
    ...
    end=EndPlaybackCommand('u',s.id,final_seq=2,final_position_ms=2000,final_client_cumulative_active_ms=2000,final_client_epoch=s.epoch)
