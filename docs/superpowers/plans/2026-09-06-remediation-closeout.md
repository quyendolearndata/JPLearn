...
**Goal (historical closeout):** Đóng thật kế hoạch [2026-09-06-web-frontend-remediation.md](2026-09-06-web-frontend-remediation.md): bù các acceptance test còn thiếu (C2/C3/C4/C5), sửa một vi phạm thiết kế ở web session storage, đưa tài liệu trạng thái về đúng sự thật (C0), và tạo evidence có SHA/log (C6). Kết quả tại `fd838d2` (217 / 21+21 / 7) là lịch sử. C4 recovery **CLOSED** sau follow-up F-01–F-03 tại `41a4009` / `d1715d2`. C5 keyboard/manual: engineering PASS, Design PARTIAL.
