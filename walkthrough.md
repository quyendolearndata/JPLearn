...
`origin/main` tại `908b6bb`. Source được kiểm chứng: `18c9e02`, tree `9cecad9`.
...
- [Evidence 2026-09-08](docs/qa/evidence/web-learning-loop-review-fixes-20260908/README.md)
...
| Full E2E Chromium + WebKit | 96/96 PASS |
...
không được dùng để chứng nhận các sửa auth/date/playback ở source `18c9e02`.
